...
###################################################################################
### Functions for 1) solving Kolmogorov backward equations from MSCE-EAC model  ###
##     using system of ODES, 2) model hazard function, 3) BE density function   ###
###################################################################################
...
######################################################
## US CENSUS DATA FOR 2010 for at-risk population ####
######################################################
...
## NUMBER OF BE CASES estimated by model (secondary outcome)
b_c1 = 1950
birth_cohort = b_c1
RR=5
...
##############################################################################
###         RESULTS FOR predicted EAC cases as primary outcome             ###
##############################################################################
...
###############################################################################
### RESULTS FOR corresponding predicted BE prevalence as secondary outcome  ###
##                  -  VALIDATION WITH CORI FOR MALES/FEMALES               ###
###############################################################################
...
#############################################################################################
##  Sensitivity Analysis: CHANGING GERD PREV, include in Supplementary material , Figure S1 #
#############################################################################################
w=seq(0,20, .25)
RR=5
birth_cohort = 1950
...
##################################################################################################
## Sensitivity Analysis:: How many EACs does the model predict if BE prev in GERD               ##
##                                subpopulation was lower: Figure S2.                           ##
...
############################################################################## 
## Compute number of EACs that arise when assuming much lower RR =3,4      ###
##############################################################################
RR=3
age_groups = seq(42.5,87.5,by=5)
Lambda_m = rep(0,length(age_groups))
...
## Calculates BE prevalence % at age 55 and 75 for RR=3 and 4, in Supplementary
